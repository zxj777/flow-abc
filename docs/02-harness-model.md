...
**定义在 `.ai/rules/review.md` 中**，通过两种方式自动加载：
- **CLI 流程驱动**：流程模板在 Review 步骤指令 AI 读取 `.ai/rules/review.md`
- **Coding Agent**：编译为 `AGENTS.md` 后自动加载

**检查维度**：

```markdown
# AGENTS.md — Code Review 规则
