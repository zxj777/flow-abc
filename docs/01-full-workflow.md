...
│          │    │ (可选)    │    │          │    │          │    │          │    │          │
│ 需求文档源 │    │ Figma MCP │    │ 组件匹配  │    │ 规则约束  │    │ 混合TDD  │    │ AI+人工  │
└──────────┘    └──────────┘    └──────────┘    └──────────┘    └──────────┘    └──────────┘
      │                                                                               │
      │              PRD 有截图时可跳过设计稿                                            │
      └─────────────────────────────────────────────────────────────────────────────────┘
...
从任意文档来源获取 PRD / 需求文档内容，提供给 Copilot CLI 作为上下文。
...
AI Review 规则定义在 `.ai/rules/review.md` 中，不编译到 `copilot-instructions.md`，而是由流程模板在 Review 步骤按需读取。这样确保 Review 规则只在代码审查时加载，不干扰日常编码。
...
|------|------|------|------|-----------|---------|
| 需求分析 | PRD / 需求文档 | 页面规格书 | 文档来源 + Copilot | Review 规格书 | 否 |
